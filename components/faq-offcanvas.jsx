...
const FaqOffCanvas = () => {
  ...
  return (
    <div
      id="hs-overlay-right"
      className="hs-overlay hs-overlay-open:translate-x-0 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform h-full max-w-lg w-full z-[80] bg-[#1F1F38] dark:bg-gray-800 dark:border-gray-700 bg-[#1F1F38]"
      tabIndex="-1"
    >
      ...
      <div className="px-8 ">
        <div className="flex items-center py-6">
          ...
          <p className="font-bold text-xl ps-2 text-[#F7E8D3]">FAQ</p>
        </div>
